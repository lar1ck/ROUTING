    ...
    <>
      <div className="font-mono">
        <nav className="font-sans  flex place-content-center	mt-2 mx-1 rounded-md p-2 justify-between px-24">
          ...
          <div >
            <Link to="/login" className=" border-x-gray-600 border-4 w-24 rounded-full place-content-center flex items-center hover:bg-gray-200 duration-300 p-1">Login</Link>
          </div>
        </nav>
      </div>
      <Outlet />
